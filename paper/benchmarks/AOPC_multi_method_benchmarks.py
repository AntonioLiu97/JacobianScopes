...
# modes = ['Semantic', 'gradient_x_input','Fisher', "random_ablation", 'IG']
modes = ['IG']
# modes = ['Temperature']
# modes = ['Temperature']
# fisher_k = 4
...
### BOS is not required for LLaMA
# model_name = "meta-llama/Llama-3.2-1B"
# model_name = "meta-llama/Llama-3.2-3B"
# model_name = "meta-llama/Llama-3.1-8B"

### BOS is not applicable for LLaMA
# model_name = "Qwen/Qwen2.5-3B"
# model_name = "Qwen/Qwen2.5-1.5B"
# front_pad = 0

### BOS is mandatory for Gemma
...
# for prompts_path, dataset_name_short in zip([Path("../data/lambada_prompts_1000.json"), Path("../data/IWSLT2017DE_EN.json")],["lmbd1000","IWSLT2017DE_EN"]):
for prompts_path, dataset_name_short in zip([Path("../data/IWSLT2017DE_EN.json")],["IWSLT2017DE_EN"]):
    num_prompts = 1000    
    np.random.seed(42)    
